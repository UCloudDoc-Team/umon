...
| ---------- | --------- | ------------------------------------------------------------ | ---- |
| 2024.10.15 | v1.2.6    | 新增 针对GPU云主机支持驱动识别的GPU卡数量、硬件识别的GPU卡数量指标采集`（仅限于A800 的所有行业镜像、H20 的所有行业镜像、高性价比显卡6的 Ubuntu所有版本及所有行业镜像、高性价比显卡6pro的 Ubuntu所有版本及所有行业镜像的GPU）`                      |详情见附录1     |
...
| 2016.03.25 | v1.0.2    | 优化 Linux版本tcp连接数采集 |      |
...
> 2、监控代理只支持4.18以下内核版本，使用内核4.18以上和UMA配合使用，可能出现部分指标无法获取的情况
...
|镜像名称|操作系统|集成软件|
|:----|:----|:----|
|预装驱动|CentOS 7.6 64位|nvidia535.54.03  cuda12.2|
|预装驱动|CentOS 7.9 64位|nvidia535.54.03  cuda12.2|
|预装驱动|Ubuntu 20.04 64位|nvidia535.54.03  cuda12.2|
|预装驱动|Ubuntu 22.04 64位|nvidia535.54.03  cuda12.2|

H20：
镜像市场：
|镜像名称|操作系统|集成软件|
|:----|:----|:----|
|预装驱动|Ubuntu 20.04 64位|nvidia550.90.07  cuda12.4  ofed23.10  uefi|
|预装驱动|Ubuntu 22.04 64位|nvidia550.90.07  cuda12.4  ofed23.10  uefi|


高性价比显卡6：
基础镜像：Ubuntu：24.04、22.04、20.04、18.04、16.04、14.04
镜像市场：
|镜像名称|操作系统|集成软件|
|:----|:----|:----|
...
|预装驱动|Ubuntu 22.04 64位|nvidia545.23.08  cuda12.3|
...
高性价比显卡6增强型：
基础镜像：Ubuntu：24.04、22.04、20.04、18.04、16.04
镜像市场：
|镜像名称|操作系统|集成软件|
|:----|:----|:----|
|预装驱动|Ubuntu 20.04 64位|nvidia535.54.03  cuda12.1|
